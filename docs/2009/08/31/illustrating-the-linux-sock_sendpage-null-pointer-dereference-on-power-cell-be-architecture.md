...
{{ meta("Ramon de C Valle", "rcvalle", "rcvalle-gravatar.7xz9k@simplelogin.com", page.meta.published, page.meta.updated) }} -->
<aside class="mdx-font-size-small" markdown>
:material-calendar:{ title="Published" } {{ page.meta.published.strftime("%b %-d, %Y") }}
{%- if page.meta.updated %}
· :material-calendar-check:{ title="Updated" } {{ page.meta.updated.strftime("%b %-d, %Y") }}
{%- endif %}
</aside>
